...
//建立一個ImageSpan元件並帶入要插入的圖片
        ImageSpan mImageSpan = new ImageSpan(Main3Activity.this, R.drawable.ic_menu_sort_by_size);
...
//將組合後的文字圖片放入TextView裡
        ...
        button33.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                startActivity(i);
                Toast.makeText(Main3Activity.this, "回首頁",Toast.LENGTH_SHORT).show();
                onBackPressed();
        ...
        button2.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                Intent i=new Intent();
                i.setClass(Main3Activity.this,Main3Activity.class);
                startActivity(i);
                Toast.makeText(Main3Activity.this, "備忘錄讀取中",Toast.LENGTH_SHORT).show();
                onBackPressed();
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                startActivity(i);
                Toast.makeText(Main3Activity.this, "行事曆讀取中",Toast.LENGTH_SHORT).show();
                onBackPressed();
        ...
        button3.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                startActivity(i);
                Toast.makeText(Main3Activity.this, "提醒事項讀取中",Toast.LENGTH_SHORT).show();
                onBackPressed();
